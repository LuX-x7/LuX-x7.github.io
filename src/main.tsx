...
function About() {
  return <main>
    ...
    <section className="text-section"><h2>Education</h2>
      ...
      <div className="dated-item"><time>2022–2026</time><div><h3>B.Eng. in Electronic Information Engineering</h3><p>Nanchang University</p><p>Advisor: Professor <LinkOut href="https://teacher.ncu.edu.cn/publish/wufahui/">Fahui Wu</LinkOut></p></div><img className="institution-logo" src="/logos/ncu.png" alt="Nanchang University emblem" /></div>
    </section>
