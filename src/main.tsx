...
function About() {
  return <main>
    ...
    <section className="text-section"><h2>Biography</h2><p>I am Xiao Lu (肖路), a master&apos;s student in the School of Artificial Intelligence and Robotics at Hunan University, where I work on robotic manipulation. I earned my B.Eng. in Electronic Information Engineering from Jiluan Academy at Nanchang University, completed six months of research training through the April programme at Shenzhen X-Institute, and later served as a visiting student at Tsinghua University and Westlake University.</p><p>My earlier work included ZnO catalysts for soot removal in industrial thermocatalysis, visual monitoring of electrochemical corrosion in alloys, reinforcement-learning-based dynamic obstacle avoidance for robotic arms, and the construction of an indoor-environment UAV benchmark. I began my undergraduate studies in chemistry before moving through electronic information engineering to artificial intelligence. This winding path was not a lack of focus; each step helped me understand what I did not want and, ultimately, identify what I do want to pursue. Every experience has been meaningful in bringing me closer to that direction.</p></section>
