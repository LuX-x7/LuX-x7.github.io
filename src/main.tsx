...
function About() {
  return <main>
    ...
    <section className="text-section"><h2>Biography</h2><p>I am Xiao Lu (肖路), a master&apos;s student in the School of Artificial Intelligence and Robotics at Hunan University, where I work on robotic manipulation.</p><p>I earned my B.Eng. in Electronic Information Engineering from Jiluan Academy at Nanchang University. I also completed six months of research training through the April programme at Shenzhen X-Institute, and later served as a visiting student at Tsinghua University and Westlake University.</p><p>Before arriving at my current direction, I worked on ZnO catalysts for soot removal in industrial thermocatalysis; visual monitoring of electrochemical corrosion in alloys; dynamic obstacle-avoidance path planning for robotic arms using reinforcement learning; and the construction of an indoor-environment UAV benchmark.</p><p>Please do not be surprised by the breadth of these experiences. I began my undergraduate studies in chemistry, then, through a difficult and sometimes uncertain process, moved into electronic information engineering and eventually into artificial intelligence. This was not a sign that I lacked commitment to research. Rather, each step helped me understand more clearly what I did not want. Many people discover their interests in their undergraduate years—or even earlier—and are fortunate enough to spend their lives pursuing them. I was not so lucky; my journey has simply been longer.</p><p>Yet every stage has mattered. These experiences have helped me find what genuinely interests me and have made me increasingly certain about the direction I want to pursue.</p></section>
    <section className="text-section"><h2>Education</h2>
      <div className="dated-item"><time>2026.09–2029.06 (Expected)</time><div><h3>M.Sc. in Artificial Intelligence</h3><p>School of Artificial Intelligence and Robotics, Hunan University</p><p>Advisor: Professor <LinkOut href="https://robotics.hnu.edu.cn/info/1176/3115.htm">Leyuan Fang</LinkOut></p></div><img className="institution-logo" src="/logos/hnu.png" alt="Hunan University emblem" /></div>
      <div className="dated-item"><time>2022.09–2026.06</time><div><h3>B.Eng. in Electronic Information Engineering</h3><p>Jiluan Academy,Nanchang University</p><p>Advisor: Professor <LinkOut href="https://teacher.ncu.edu.cn/publish/wufahui/">Fahui Wu</LinkOut></p></div><img className="institution-logo" src="/logos/ncu.png" alt="Nanchang University emblem" /></div>
    </section>
    <section className="text-section"><h2>Research Experience</h2>
      ...
      <div className="dated-item"><time>2023.06–2025.01</time><div><h3>Intern</h3><p>Nanchang University</p><p>Mentor: Professor <LinkOut href="https://teacher.ncu.edu.cn/publish/091727/index.html">Zhi Hu</LinkOut></p></div><img className="institution-logo" src="/logos/ncu.png" alt="Nanchang University emblem" /></div>
