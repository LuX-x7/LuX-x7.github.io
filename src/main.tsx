...
function About() {
  return <main>
    ...
    <section className="text-section"><h2>Education</h2>
      ...
      <div className="dated-item"><time>2022–2026</time><div><h3>B.Eng. in Electronic Information Engineering</h3><p>Nanchang University</p><p>Undergraduate advisor: Associate Professor <LinkOut href="https://teacher.ncu.edu.cn/publish/wufahui/">Fahui Wu</LinkOut></p></div><img className="institution-logo" src="/logos/ncu.png" alt="Nanchang University emblem" /></div>
    </section>
    <section className="text-section"><h2>Research Experience</h2>
      ...
      <div className="dated-item"><time>2025 Jan–Sep</time><div><h3>Research Training Programme</h3><p><LinkOut href="https://www.x-institute.edu.cn/">Shenzhen X-Institute</LinkOut> &amp; <LinkOut href="https://www.sigs.tsinghua.edu.cn/main.htm">Tsinghua SIGS</LinkOut></p><p>Mentor: Professor <LinkOut href="https://www.sigs.tsinghua.edu.cn/wxq/list.htm">Xueqian Wang</LinkOut></p></div><div className="institution-logos"><img className="institution-logo institution-logo-wide" src="/logos/x-institute.jpg" alt="Shenzhen X-Institute logo" /><img className="institution-logo" src="/logos/tsinghua.png" alt="Tsinghua University emblem" /></div></div>
