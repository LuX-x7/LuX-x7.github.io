...
function About() {
  return <main>
    ...
    <section className="text-section"><h2>Biography</h2><p>I am Lu Xiao (肖路), a master&apos;s student in the School of Artificial Intelligence and Robotics at Hunan University. My research interests include deep reinforcement learning, robot learning, and robotic manipulation.</p><p>I received my B.Eng. in Electronic Information Engineering from Nanchang University in June 2026. During my undergraduate studies, I explored research across chemistry, electronic information engineering, robotics, and artificial intelligence. I also completed research training at Shenzhen X-Institute and Tsinghua SIGS, and was a visiting student in Professor <LinkOut href="https://haibinling.github.io/">Haibin Ling&apos;s</LinkOut> lab at Westlake University.</p></section>
